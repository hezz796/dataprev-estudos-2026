...
```mermaid
flowchart TD
    A[Palavra] --> B[Qual é a sílaba tônica?]
    B --> C[Última: oxítona]
    B --> D[Penúltima: paroxítona]
    B --> E[Antepenúltima ou antes: proparoxítona]
    E --> F[Todas se acentuam]
    D --> G[Termina em -i, -us, -um, -l, -n, -r, -x, -ps, -ã, -ão, -ei, ditongo...?]
    G --> H[Sim: acentua]
    G --> I[Não: palavra segue sem acento]
    C --> J[Termina em -a, -e, -o, -em, -ens, éi, éu, ói...?]
    J --> K[Sim: acentua]
    J --> L[Não: palavra segue sem acento]
```
